...
public class OpenReportConfig {
	...
	private void initialize() {
		...
		gridBagLayout.rowHeights = new int[]{39, 50, 100, 0, 35, 0};
		...
		frame.getContentPane().setLayout(gridBagLayout);
				...
				gbl_schedulePanel.columnWidths = new int[]{15, 64, 558, 0};
				...
				tglbtnSun.setFont(new Font("Tahoma", Font.PLAIN, 9));
				...
				tglbtnMon.setFont(new Font("Tahoma", Font.PLAIN, 9));
				...
				tglbtnTue.setFont(new Font("Tahoma", Font.PLAIN, 9));
				...
				tglbtnWed.setFont(new Font("Tahoma", Font.PLAIN, 9));
				...
				tglbtnThu.setFont(new Font("Tahoma", Font.PLAIN, 9));
				...
				tglbtnFrid.setFont(new Font("Tahoma", Font.PLAIN, 9));
				...
				tglbtnSat.setFont(new Font("Tahoma", Font.PLAIN, 9));
